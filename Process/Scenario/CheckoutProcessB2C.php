...
namespace Vespolina\CheckoutBundle\Process\Scenario;

use Vespolina\CheckoutBundle\Process\AbstractProcess;
...
class CheckoutProcessB2C extends AbstractProcess
{
    ...
    {
        return array(
            'identify_customer'      => 'Vespolina\CheckoutBundle\Process\Step\IdentifyCustomer',
            'determine_fulfillment'  => 'Vespolina\CheckoutBundle\Process\Step\DetermineFulfillment',
            'select_payment_method'  => 'Vespolina\CheckoutBundle\Process\Step\SelectPaymentMethod',
            'review_checkout'        => 'Vespolina\CheckoutBundle\Process\Step\ReviewCheckout',
            'execute_payment'        => 'Vespolina\CheckoutBundle\Process\Step\ExecutePayment',
            'complete_checkout'      => 'Vespolina\CheckoutBundle\Process\Step\CompleteCheckout',
