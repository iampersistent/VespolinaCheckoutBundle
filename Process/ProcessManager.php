 ...
 */
namespace Vespolina\CheckoutBundle\Process;

use Symfony\Component\DependencyInjection\ContainerAware;

use Vespolina\CheckoutBundle\Process\ProcessInterface;
use Vespolina\CheckoutBundle\Process\ProcessManagerInterface;
 ...
 */
 class ProcessManager extends ContainerAware implements ProcessManagerInterface {
    ...
    {
        return array(
            'checkout_b2c' =>  'Vespolina\CheckoutBundle\Process\Scenario\CheckoutProcessB2C'
        );
    }
