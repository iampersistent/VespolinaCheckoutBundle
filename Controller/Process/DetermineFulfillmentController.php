...
use Vespolina\CheckoutBundle\Form\Type\Process\SelectFulfillmentMethodFormType;
...
class DetermineFulfillmentController extends AbstractProcessStepController
{
    public function executeAction()
    {
        ...
        if ($this->isPostForForm($request, $selectFulfillmentForm)) {
            ...
            return $this->render('VespolinaCheckoutBundle:Process:Step/determineFulfillment.html.twig',
